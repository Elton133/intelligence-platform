  ...
  return (
    <div className="min-h-screen bg-[#030305] text-white flex overflow-hidden selection:bg-cyan-500/30 font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-b from-cyan-900/10 to-transparent rounded-full blur-[100px] pointer-events-none -z-10" />
